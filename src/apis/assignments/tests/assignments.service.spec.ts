...
describe('AssignmentsService', () => {
    ...
    describe('create', () => {
        ...
        it('should reject duplicate assignment', async () => {
            const error = new Error('Driver already has an active vehicle assignment') as Error & { code?: number };
    ...
    describe('remove (unassign)', () => {
        it('should unassign a driver from vehicle', async () => {
            ...
            expect(result.status).toBe(HttpStatus.OK);
            expect(result.message).toBe('Driver unassigned from vehicle successfully');
        });
